...
from .types import serialize_value, coerce_value
...
def save_json_text(db: Database) -> str:
    return json.dumps(db_to_dict(db), ensure_ascii=False, indent=2)

def load_json_text(s: str) -> Database:
    return db_from_dict(json.loads(s))
